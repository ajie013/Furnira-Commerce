...
const UpdateProduct: React.FC<UpdateProductProps> = ({
  ...
  const [previousProduct, setPreviousProduct] = useState<UpdateProductFormData>({
    name: "",
    price: null,
    stock: null,
    categoryId: null,
          ...
          <DialogDescription>
            {!product || isLoadingCategories ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {/* Submit Button */}
                <Button className="w-full mt-4 p-2" type="submit" disabled={updateProductMutation.isPending}>
